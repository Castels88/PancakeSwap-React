    ...
    return(
        <div>
            <div className="Navbar_settings_menu">
                <svg onClick={()=> setToogle(!Toogle)} viewbox="0 0 24 24" height="24" width="24" color="#7A6EAA;"
                ...
                <div class="appear">
                    ...
                    <div class="settings_container">
                        <div class="settings_top">
                            Settings
                            <img onClick={()=> setToogle(!Toogle)} src={Exit}/>
                        </div>
                        <div class="settings_scroolbar">
                            <div class="primo_conteiner">
                                ...
                                <div class="font_settings2">Default Transaction Speed (GWEI)
                                    
                                </div>
                                <div class="trebottoni">
                                    <button class="btn_settings"> <span>Standard(5)</span></button>
                                    <button class="btn_settings"><span>Fast(6)</span></button>
                                    <button class="btn_settings"><span>Instant(7)</span></button>
                                </div>
                            </div>
                        </div>
                    </div>

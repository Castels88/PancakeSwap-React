const Navbar = () => {
    return ( 
    <nav>
        <div class="Navbar_sinistra">
            <a href="//https://pancakeswap.finance/">
                <div><svg viewbox="0 0 198 199" class="sc-eaf7e66-0 mvupn mobile-icon" color="text"
                ...
                <div class="Navbar_logo">PancakeSwap</div>
            </a>
            <div class="Navbar_bottoni">
                <ul class="Navbar_menuBtn">
                    <li>
        ...
        <div class="Navbar_destra">
            <div class="icon"><svg viewbox="0 0 96 96" width="24px" color="text" xmlns="http://www.w3.org/2000/svg"
                    class="sc-eaf7e66-0 fqyouR">
            ...
            <div>
                <div class="Navbar_settings_menu"><svg viewbox="0 0 24 24" height="24" width="24" color="#7A6EAA;"
                        xmlns="http://www.w3.org/2000/svg" class="sc-eaf7e66-0 bXujD">
                        <path
            ...
            <button class="Navbar_main_buttons">Connect Wallet</button>
        </div>
    </nav>

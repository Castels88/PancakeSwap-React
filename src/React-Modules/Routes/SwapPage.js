...
export function SwapPage() {
  ...
  const [secondToogle, setSecondToogle] = useState(true)
  const [botToogle, setbotToogle] = useState(true)
  const [footerToogle, setfooterToogle] = useState(true)
          ...
          {toogle && (
            <div className="swap_charts">
              ...
              <img
                onClick={() =>
                  setToogle(!toogle) ||
                  setSecondToogle(!secondToogle) ||
                  setbotToogle(!secondToogle) ||
                  setfooterToogle(!secondToogle)
                }
                className="swap_chart_exit"
                src={Exit}
                alt=""
              />
            </div>

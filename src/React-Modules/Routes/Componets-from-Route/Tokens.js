...
import useSelect from '../../API/Custom Hooks/useSelect.js'
import { roundOff } from '../../API/tokens/script'
...
export function Tokens() {
  ...
  const {coinData: firstCoin, setCoinData: setFirstCoin, value: firstValue, setValue: setFirstValue, changeHandler: changeFirstHandler} = useSelect(fetchData)
  const {coinData: secondCoin, setCoinData: setSecondCoin, value: secondValue, setValue: setSecondValue, changeHandler: changeSecondHandler} = useSelect(fetchData)
  ...
  return (
    <>
      <div onClick={() => setToogle(!Toogle)} className="swap_SVG_container">
       ...
       { fetchData && <img className="swap_SVG_BNB" src={firstValue.image} alt={firstValue.id} />}
        { fetchData &&<p className="swap-text">{firstValue.id}</p>}
        {/* <svg
              ...
              <div className="swap_crypto_container">
                {crypto &&
                  crypto
                    ...
                    .map((value, index) => (
                      <button onClick={handleFirstDecision} value={firstValue.id}>
...
{ fetchData && <img className="swap_SVG_BNB" src={secondValue.image} alt={secondValue.id} />}
 { fetchData &&<p className="swap-text">{secondValue.id}</p>}
 {/* <svg
   className="swap_SVG_cake"
   viewBox="0 0 24 24"
   color="text"

import fpancakelogo from "./images/PancakeSwap.png";
    ...
    <footer>
      <div className="footer__main">
        <ul className="main-about">
          <li className="footer__main-title">ABOUT</li>
          <li className="footer__main-secondary">Contact</li>
          <li className="footer__main-default">Brand</li>
          <li className="footer__main-default">Blog</li>
          <li className="footer__main-default">Community</li>
          <li className="footer__main-default">Litepaper</li>
          <li className="footer__main-default">--</li>
          <li className="footer__main-default">Online Store</li>
        </ul>
        <ul className="main-help">
          <li className="footer__main-title">HELP</li>
          <li className="footer__main-default">Customer Support</li>
          <li className="footer__main-default">Trobuleshooting</li>
          <li className="footer__main-default">Guides</li>
        </ul>
        <ul className="main-developers">
          <li className="footer__main-title">DEVELOPERS</li>
          <li className="footer__main-default">Github</li>
          <li className="footer__main-default">Documentation</li>
          <li className="footer__main-default">Bug Bounty</li>
          <li className="footer__main-default">Audits</li>
